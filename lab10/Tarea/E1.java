...
public class E1{
    ...
    public static void batalla(Soldado amigo, Soldado enemigo, int x, int y){
		System.out.println(amigo.getNombre() + ": " + amigo.getVidaActual() + " 		VS		 " + enemigo.getNombre() + ": "+ enemigo.getVidaActual());
    	if(enemigo.getVidaActual() < amigo.getVidaActual()){
			System.out.println("Gana el soldado " + amigo.getNombre());
			enemigo.morir();
			amigo.setFila(x);
			amigo.setColumna(y);
		}else if(enemigo.getVidaActual() > amigo.getVidaActual()){
